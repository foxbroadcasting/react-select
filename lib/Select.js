...
var _DragDropContainer = require('./dnd/DragDropContainer');

var _DragDropContainer2 = _interopRequireDefault(_DragDropContainer);

var _DragDropItem = require('./dnd/DragDropItem');

var _DragDropItem2 = _interopRequireDefault(_DragDropItem);
...
var Select = function (_React$Component) {
   ...
   */
		...
		value: function renderValue(valueArray, isOpen) {
			...
			var placeholderDiv = isUnique ? _react2.default.createElement(
				'div',
		...
		value: function filterOptions(excludeOptions) {
			...
			if (extraOptions.length) {
				...
				options = [].concat(_toConsumableArray(filteredExtraOptions), _toConsumableArray(options));
			}
...
Select.propTypes = {
	...
	extraOptions: _propTypes2.default.array, // an optional array of options to display in the dropdown according to the filter
	...
	reorder: _propTypes2.default.bool,
	...
	type: _propTypes2.default.string, // which select type we use
...
exports.default = (0, _reactDnd.DragDropContext)(_reactDndHtml5Backend2.default)(Select);