	...
	createClass(Option, [{
		...
		value: function render() {
			...
			return option.disabled ? React.createElement(
				...
				'div',
				null,
				this.props.isFocused && React.createElement(
					'span',
					null,
					React.createElement(
						'g',
...
var DragDropItem$1 = DragSource(MULTI_SELECT, dragSource, collect$1)(DragDropItem);
...
var Select$2 = DragDropContext(HTML5Backend)(Select$1);
...
function defaultChildren(props) {
	return React.createElement(Select$2, props);
}
				...
				function (asyncProps) {
					return React.createElement(
						...
						function (creatableProps) {
							return React.createElement(Select$2, _extends({}, reduce(asyncProps, reduce(creatableProps, {})), {
