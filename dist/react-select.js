(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('prop-types'), require('react-dom'), require('react-input-autosize'), require('classnames'), require('react-dnd-html5-backend'), require('react-dnd')) :
	typeof define === 'function' && define.amd ? define(['react', 'prop-types', 'react-dom', 'react-input-autosize', 'classnames', 'react-dnd-html5-backend', 'react-dnd'], factory) :
	(global.Select = factory(global.React,global.PropTypes,global.ReactDOM,global.AutosizeInput,global.classNames,global['react-dnd-html5-backend'],global['react-dnd']));
}(this, (function (React,PropTypes,ReactDOM,AutosizeInput,classNames,HTML5Backend,reactDnd) { 'use strict';
...
var DragDropContainer = React__default.createClass({

	displayName: 'DragDropContainer',

	propTypes: {
		canDrop: React__default.PropTypes.bool,
		children: React__default.PropTypes.any,
		className: React__default.PropTypes.string,
		connectDropTarget: React__default.PropTypes.func,
		contextId: React__default.PropTypes.oneOfType([React__default.PropTypes.number, React__default.PropTypes.string]), //Unique Identifier for the drag context (parent component which contains the dnd context)
		handleSorting: React__default.PropTypes.func.isRequired,
...
var DragDropContainer$1 = reactDnd.DropTarget(MULTI_SELECT, target, collect)(DragDropContainer);

var DragDropItem = React__default.createClass({

	displayName: 'DragDropItem',

	propTypes: {
		children: React__default.PropTypes.any,
		connectDragPreview: React__default.PropTypes.func.isRequired,
		connectDragSource: React__default.PropTypes.func.isRequired,
		isDragging: React__default.PropTypes.bool.isRequired,
		previewHeight: React__default.PropTypes.string,
		previewHtml: React__default.PropTypes.any,
		previewUrl: React__default.PropTypes.oneOfType([React__default.PropTypes.bool, React__default.PropTypes.string]),
		previewWidth: React__default.PropTypes.string
	},
	...
	render: function render() {
		...
		return connectDragSource(React__default.createElement(
			'div',
			null,
...
var DragDropItem$1 = reactDnd.DragSource(MULTI_SELECT, dragSource, collect$1)(DragDropItem);
...
var Select$1 = function (_React$Component) {
   ...
   */
		...
		key: 'reorderValueArray',
		value: function reorderValueArray(srcIndex, targetIndex) {
			if (srcIndex === targetIndex) return;
			var valueArray = this.getValueArray(this.props.value);
			var spliced = valueArray.splice(srcIndex, 1);
			valueArray.splice.apply(valueArray, [targetIndex, 0].concat(toConsumableArray(spliced)));
		...
		key: 'renderMultiValueComponent',
		value: function renderMultiValueComponent(value, index, reorder) {
					...
					return valueArray.map(function (value, i) {
						...
						return React__default.createElement(
							DragDropContainer$1,
							{
								key: i,
								index: i,
								contextId: _this5._instancePrefix,
								className: 'Select-drag-container',
								handleSorting: _this5.reorderValueArray
							},
							React__default.createElement(
								DragDropItem$1,
								{
								...
								_this5.renderMultiValueComponent(value, i, reorder)
							)
						);
					});
				} else {
		...
		value: function filterOptions$$1(excludeOptions) {
			...
			if (extraOptions.length) {
				...
				var filteredExtraOptions = extraOptions.filter(function (value) {
...
var Select$2 = reactDnd.DragDropContext(HTML5Backend)(Select$1);
...
function defaultChildren(props) {
	return React__default.createElement(Select$2, props);
}
	...
	createClass(CreatableSelect, [{
		...
		value: function render() {
			...
			var props = _extends({}, restProps, {
				...
				ref: function ref(_ref2) {
					if (_ref2) {
						var select = _ref2.child;

						_this2.select = select;
						_this2.labelKey = select.props.labelKey;
						_this2.valueKey = select.props.valueKey;
					}
				}
			});
				...
				function (asyncProps) {
					return React__default.createElement(
						...
						function (creatableProps) {
							return React__default.createElement(Select$2, _extends({}, reduce(asyncProps, reduce(creatableProps, {})), {
...
Select$2.Async = Async;
Select$2.AsyncCreatable = AsyncCreatableSelect;
Select$2.Creatable = CreatableSelect;
Select$2.Value = Value;
